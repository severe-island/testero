...
module.exports.connect = function connect(safeConnect, callback)
{
  if(safeConnect){
    ...
    var connectionString ='mongodb://localhost/' + config.db.name;
  }
  var connectionToDB = mongoose.connect(connectionString);
  modelOfUser = connectionToDB.model("user", userSchema);
